...
import cloudstreamplugin.APIHolder
import cloudstreamplugin.APIHolder.removePluginMapping
import cloudstreamplugin.AcraApplication.Companion.getKey
import cloudstreamplugin.AcraApplication.Companion.removeKey
import cloudstreamplugin.AcraApplication.Companion.setKey
import cloudstreamplugin.AllLanguagesName
import cloudstreamplugin.AutoDownloadMode
import cloudstreamplugin.CommonActivity.showToast
import cloudstreamplugin.MainAPI
import cloudstreamplugin.MainAPI.Companion.settingsForProvider
import cloudstreamplugin.MainActivity.Companion.afterPluginsLoadedEvent
import cloudstreamplugin.PROVIDER_STATUS_DOWN
import cloudstreamplugin.PROVIDER_STATUS_OK
import cloudstreamplugin.R
import cloudstreamplugin.TvType
import cloudstreamplugin.actions.VideoClickAction
import cloudstreamplugin.actions.VideoClickActionHolder
import cloudstreamplugin.apmap
import cloudstreamplugin.mvvm.debugPrint
import cloudstreamplugin.mvvm.logError
import cloudstreamplugin.mvvm.normalSafeApiCall
import cloudstreamplugin.plugins.RepositoryManager.ONLINE_PLUGINS_FOLDER
import cloudstreamplugin.plugins.RepositoryManager.PREBUILT_REPOSITORIES
import cloudstreamplugin.plugins.RepositoryManager.downloadPluginToFile
import cloudstreamplugin.plugins.RepositoryManager.getRepoPlugins
import cloudstreamplugin.ui.settings.extensions.REPOSITORIES_KEY
import cloudstreamplugin.ui.settings.extensions.RepositoryData
import cloudstreamplugin.utils.AppContextUtils.getApiProviderLangSettings
import cloudstreamplugin.utils.AppUtils.parseJson
import cloudstreamplugin.utils.Coroutines.main
import cloudstreamplugin.utils.ExtractorApi
import cloudstreamplugin.utils.UIHelper.colorFromAttribute
import cloudstreamplugin.utils.UiText
import cloudstreamplugin.utils.VideoDownloadManager.sanitizeFilename
import cloudstreamplugin.utils.extractorApis
import cloudstreamplugin.utils.txt
